<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="品种名称" prop="goodsName">
        <el-input
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="品种名称" prop="goodsName">
          <el-input v-model="form.goodsName" placeholder="请输入品种名称" />
        </el-form-item>
        <el-form-item label="备注" prop="goodsRemark">
          <el-input v-model="form.goodsRemark" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除品种编号为"' + goodsIds + '"的数据项？').then(function() {
